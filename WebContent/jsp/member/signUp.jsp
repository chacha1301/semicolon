						...
						<div class="card-body">
							<form action="" method="">
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="memberNm" class="form-control"
											placeholder="이름 입력" name="memberNm" required autofocus>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="memberId" class="form-control"
											placeholder="아이디 입력" name="memberId" required autofocus>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="Password2" class="form-control"
											placeholder="비밀번호 재입력" name="Password2" required autofocus>
									</div>
								</div>
