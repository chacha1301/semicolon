			...
			<div class="row justify-content-center">
				<div class="col-md-6">
					<div class="card">
						...
						<form id="frm" name="frm" action="/SemiColon/SignUp.do" onsubmit="return valueCheck()"
							method="post">
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="memberId" class="form-control" placeholder="이름 입력"
								...
								<div class="form-group row">
									<label for="email_address" class="col-md-4 col-form-label text-md-right">Password
										Confirm </label>
									<div class="col-md-6">
										<input type="password" id="Password2" class="form-control"
											placeholder="비밀번호 재입력" id="password2" name="password2" required autofocus>
									</div>
								</div>
