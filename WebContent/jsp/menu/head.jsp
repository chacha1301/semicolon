					...
					<div class="containt_main">
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								...
								<a class="dropdown-item" href="#" name="netword">보안 · 네트워크</a> <a class="dropdown-item"
									href="#" name="database">데이터베이스</a> <a class="dropdown-item" href="#"
									name="skill">업무 스킬</a> <a class="dropdown-item" href="#" name="career">커리어</a> <a
			...
			<div class="banner_section layout_padding">
				<div class="container">
					<div id="my_slider" class="carousel slide" data-ride="carousel">
						...
						</a> <a class="carousel-control-next" href="#my_slider" role="button" data-slide="next"> <i
