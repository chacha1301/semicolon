						...
						<div class="card-body">
							<form action="" method="">
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="memberNm" class="form-control" placeholder="이름 입력"
											name="memberNm" required autofocus>
									</div>
								</div>
								...
								<div class="form-group row">
									<label for="email_address"
										class="col-md-4 col-form-label text-md-right">Password Confirm </label>
									<div class="col-md-6">
										<input type="text" id="Password2" class="form-control" placeholder="비밀번호 재입력"
