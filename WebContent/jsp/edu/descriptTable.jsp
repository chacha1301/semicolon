...
<!-- Bootstrap core CSS -->
<link
	href="<%=request.getContextPath()%>/bootstrap/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">

<!-- Custom styles for this template -->
<link href="<%=request.getContextPath()%>/bootstrap/css/blog-post.css"
	rel="stylesheet">

<title>Insert title here</title>
</head>
<body>
	<h3 align="center">😎🐱‍🐉내부 아이프레임 게시판😎🐱‍🐉</h3>
	<div>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link" href="#">강의소개</a></li>
					<li class="nav-item"><a class="nav-link" href="#">교육과정</a></li>
					<li class="nav-item"><a class="nav-link" href="#">수강후기</a></li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<!-- Preview Image -->
					<img class="img-fluid rounded" width="900" height="300"
						src="<%=request.getContextPath()%>images/inBanner.jpg" alt="">
